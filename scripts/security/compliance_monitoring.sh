...
# JStack Compliance Monitoring and Audit Trail System
...
# Global variables
COMPLIANCE_DIR="${COMPLIANCE_DIR:-/opt/jstack-security/compliance}"
AUDIT_DIR="${AUDIT_DIR:-/opt/jstack-security/audit}"
POLICIES_DIR="${POLICIES_DIR:-/opt/jstack-security/policies}"
EVIDENCE_DIR="${EVIDENCE_DIR:-/opt/jstack-security/evidence}"
REPORTS_DIR="${REPORTS_DIR:-/opt/jstack-security/compliance-reports}"

# Documentation variables
COMPLIANCE_DOCS_DIR="${COMPLIANCE_DOCS_PATH:-/home/jarvis/jstack/compliance/documentation}"
SITE_REGISTRY_PATH="${SITE_REGISTRY_PATH:-/home/jarvis/jstack/config/sites.json}"
...
- **Base Directory**: ${BASE_DIR:-/home/jarvis/jstack}
...
# JStack Compliance Summary Report
...
This report was automatically generated by the JStack compliance monitoring system.
